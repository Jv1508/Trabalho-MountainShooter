...
from code.Const import C_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN, EVENT_TIMEOUT, \
    TIMEOUT_STEP, TIMEOUT_LEVEL, LEVEL_TIME, ENEMY_TYPE
...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int], level_time: str):
    ...
    def run(self, player_score: list[int], enemy_type: str):
